...
class DesignationGridView extends StatefulWidget {
  ...
  @override
  State<DesignationGridView> createState() => _DesignationGridViewState();
}

class _DesignationGridViewState extends State<DesignationGridView> {
  ...
  Widget build(BuildContext context) {
    ...
    int end = (start + widget.rowsPerPage).clamp(0, widget.designationList.length);
    final paginatedDesignations = widget.designationList.sublist(start, end);

    int totalPages = (widget.designationList.length / widget.rowsPerPage).ceil();

    // Pagination show  3 page buttons
    int windowSize = 3;
    int startWindow = 0;
      ...
      children: [
        Expanded(
          child: Container(
            ...
            child: GridView.builder(
              itemCount: paginatedDesignations.length,
              ...
              itemBuilder: (context, index) {
                final designation = paginatedDesignations[index];
                ...
                return MouseRegion(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ProfileCard(
                      invoiceId: '#Desig-${designation.id.toString().padLeft(3, '0')}',
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "Showing ${widget.designationList.isEmpty ? 0 : start + 1} to $end of ${widget.designationList.length} entries",
