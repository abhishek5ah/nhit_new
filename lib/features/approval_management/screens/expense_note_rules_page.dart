...
class ExpenseNoteRulesPage extends StatefulWidget {
  const ExpenseNoteRulesPage({super.key});

  @override
  State<ExpenseNoteRulesPage> createState() => _ExpenseNoteRulesPageState();
}

class _ExpenseNoteRulesPageState extends State<ExpenseNoteRulesPage> {
    ...
    setState(() {
      filteredRules = masterList.where((rule) {
        ...
        final matchesSearch = searchQuery.isEmpty ||
            ...
            rule.department.toLowerCase().contains(searchQuery) ||
            rule.project.toLowerCase().contains(searchQuery) ||
            rule.ruleLevels.any(
              (lvl) =>
                  lvl.approverName.toLowerCase().contains(searchQuery) ||
                  lvl.level.toString().contains(searchQuery) ||
                  _amountFormat.format(lvl.amount).toLowerCase().contains(searchQuery),
            );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Manage approval rules and workflows for expense notes',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Manage and monitor all approval rules for expense notes',
