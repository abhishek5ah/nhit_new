...
class ExpenseHeader extends StatelessWidget {
  ...
  const ExpenseHeader({super.key, required this.tabIndex});
  ...
  Widget build(BuildContext context) {
    ...
    final List<_HeaderData> headerData = [
      _HeaderData(
        title: 'Expense',
        subtitle: 'Manage your expense approvals here',
      ),
      _HeaderData(
        title: 'Add Expense',
      ...
      _HeaderData(
        ...
        subtitle: 'Manage expense approval rules',
      ),
      _HeaderData(
        title: 'NHIT Western Projects Private Limited',
        subtitle: 'Note for Approval of Invoice payment',
      ),
    ];
