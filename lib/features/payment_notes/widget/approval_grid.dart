...
class ApprovalGrid extends StatefulWidget {
  final List<ApproverRule> approvalList;
  ...
  @override
  State<ApprovalGrid> createState() => _ApprovalGridState();
}

class _ApprovalGridState extends State<ApprovalGrid> {
  int? _hoveredIndex;
  ...
  Widget build(BuildContext context) {
    ...
    final end = (start + widget.rowsPerPage).clamp(0, widget.approvalList.length);
    final paginated = widget.approvalList.sublist(start, end);

    final totalPages = (widget.approvalList.length / widget.rowsPerPage).ceil();
      ...
      children: [
          ...
          child: Container(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                final approval = paginated[index];
                final globalIndex = start + index;

                final isHovered = _hoveredIndex == globalIndex;

                // hover color for grid section
                ...
                return MouseRegion(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ProfileCard(
                      invoiceId: approval.approverLevel,
                      topBarColor: color,
                      fields: {
                        'Users': approval.users.join(', '),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Showing ${widget.approvalList.isEmpty ? 0 : start + 1} to $end of ${widget.approvalList.length} entries',
