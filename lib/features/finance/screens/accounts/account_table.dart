...
class _AccountTableViewState extends State<AccountTableView> {
  ...
  Widget build(BuildContext context) {
    ...
    final columns = [
      ...
      DataColumn(label: Text('Balance', style: TextStyle(color: colorScheme.onSurface))),
    ];

    final rows = mockAccounts.map((account) {
      return DataRow(cells: [
        DataCell(Text(account.code, style: TextStyle(color: colorScheme.onSurface))),
        DataCell(Text(account.name, style: TextStyle(color: colorScheme.onSurface))),
        DataCell(
          Container(
        ...
        DataCell(Text(account.balance, style: TextStyle(color: colorScheme.onSurface))),
      ]);
    }).toList();
