...
class DepartmentGridView extends StatefulWidget {
  ...
  @override
  State<DepartmentGridView> createState() => _DepartmentGridViewState();
}

class _DepartmentGridViewState extends State<DepartmentGridView> {
  ...
  Widget build(BuildContext context) {
    ...
    int end = (start + widget.rowsPerPage).clamp(0, widget.departmentList.length);
    final paginatedDepartments = widget.departmentList.sublist(start, end);

    int totalPages = (widget.departmentList.length / widget.rowsPerPage).ceil();
      ...
      children: [
        Expanded(
          child: Container(
            ...
            child: GridView.builder(
              itemCount: paginatedDepartments.length,
              ...
              itemBuilder: (context, index) {
                final department = paginatedDepartments[index];
                ...
                return MouseRegion(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: ProfileCard(
                      invoiceId: '#Dept-${department.id.toString().padLeft(3, '0')}',
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "Showing ${widget.departmentList.isEmpty ? 0 : start + 1} to $end of ${widget.departmentList.length} entries",
